...
export default function CreateGolongan() {
    ...
    return (
        <AppLayout>
            <Head title="Create Golongan" />

            <h2 className="font-semibold text-xl text-gray-800 leading-tight">Create New Golongan</h2>
